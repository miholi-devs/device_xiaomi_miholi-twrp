...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_miholi
TARGET_RECOVERY_DEVICE_MODULES := libinit_miholi
...
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/moonstone/Image
